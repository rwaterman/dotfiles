...
description: Two-tier memory system that makes Codex a true workplace collaborator. Decodes shorthand, acronyms, nicknames, and internal language so Codex understands requests like a colleague would. AGENTS.md for working memory, memory/ directory for the full knowledge base.
user-invocable: false
---

# Memory Management

Memory makes Codex your workplace collaborator - someone who speaks your internal language.
